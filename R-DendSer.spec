...
%setup -q -n DendSer
pushd ..
cp -a DendSer buildavx2
popd
pushd ..
cp -a DendSer buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737138769
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/DendSer/libs/DendSer.so
/V4/usr/lib64/R/library/DendSer/libs/DendSer.so
